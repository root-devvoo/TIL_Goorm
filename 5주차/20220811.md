...
> `yum install mod_wsgi`로 설치
>
> ![image](https://user-images.githubusercontent.com/78403443/184100404-b8cd1e18-a72f-4fff-b133-b932f2cab7ee.png)
>
> 설정 파일은 여깄다. (위 이미지 참고)
>
> `vim /etc/httpd/conf/httpd.conf` 들어감
>
> ![image](https://user-images.githubusercontent.com/78403443/184100930-71e28977-0bb0-4893-8bc4-b02281f00d47.png)
>
> 이렇게 위와 같이 작성하고 저장.
>
> `systemctl restart httpd.service` 명령어로 재시작해줌.
>
> `cd /var/www/cgi-bin/` 여기로 이동해서 파일을 만들어본다.
>
> 경로 이동 후 `vim test.py` 명령어로 파일 편집 ㄱㄱ
>
> ![image](https://user-images.githubusercontent.com/78403443/184102012-b148da09-dae6-4ed3-b170-c494260d8322.png)
>
> 이렇게 작성 후 저장.
>
> ![image](https://user-images.githubusercontent.com/78403443/184101693-e5ab4e68-64cf-44bf-a9ec-a67a17f1e3c0.png)
>
> 위와 같이, 실행권한이 없어서 실행권한 줬다.
>
> 접속 ㄱㄱ
>
> (강사님이 테스트 후 다시 진행)
